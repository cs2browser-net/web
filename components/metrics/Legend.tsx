        ...
        <div className="p-4 md:p-6">
            ...
            <div className="grid grid-cols-1 gap-4">
                <div className="flex items-start space-x-3">
                    <div className="w-4 h-4 bg-[#ff6b6b] rounded-full mt-0.5 shrink-0"></div>
                    <div>
                ...
                <div className="flex items-start space-x-3">
                    <div className="w-4 h-4 bg-[#00feed] rounded-full mt-0.5 shrink-0"></div>
                    <div>
                ...
                <div className="flex items-start space-x-3">
                    <div className="w-4 h-4 bg-[#22c55e] rounded-full mt-0.5 shrink-0"></div>
                    <div>
