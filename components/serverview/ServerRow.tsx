...
export default function ServerRow({ isEven, server }: ServerRowProps) {
    ...
    return (
        <>
            ...
            <div
                className={`
                hidden md:grid grid-cols-[3fr_1fr_1.3fr_0.2fr_1.2fr_0.6fr] gap-1 items-center cursor-pointer min-h-12 py-2 group
            ...
            >
                <div className="flex items-center min-w-0 py-1 w-full">
                    ...
                    <Link href={`/server/${server.Server.id}`} prefetch={"auto"} className="min-w-0 flex-1">
                ...
                <div className="text-center py-1 w-full">
                    ...
                    <div className="text-xs text-gray-500 leading-tight" style={{ wordBreak: 'break-word', overflowWrap: 'anywhere' }}>
                        {server.ServerData.botsCount > 0 ? `(${server.ServerData.botsCount} bot${server.ServerData.botsCount > 1 ? 's' : ''})` : ''}
                    </div>
                </div>
                ...
                <div className="text-center py-1 w-full">
                    <div
                        className="relative overflow-hidden rounded px-2 xl:px-4 py-2 bg-cover bg-center bg-no-repeat min-h-8 w-full flex items-center justify-center"
                    >
