            ...
            feature: [
                {
                    ...
                    description:
                        "Reintroduced client-side filtering, sorting, and pagination for server lists with full parity for existing filter behavior.",
                    details: [
            ...
            performance: [
                {
                    ...
                    description:
                        "Added versioned server snapshot compression/decompression to reduce payload overhead when fetching all servers for client-side processing.",
                    details: [
            ...
            performance: [
                {
                    ...
                    description:
                        "Reduced repeated database and aggregation work in core browsing routes.",
                    details: [
            ...
            bugfix: [
                {
                    ...
                    description:
                        "Fixed BunnyHop matching to avoid false positives by requiring map-prefix validation in addition to primary text matching.",
                    details: [
            ...
            feature: [
                {
                    ...
                    description:
                        "Replaced local MMDB lookups with a dedicated GeoIP service client for IP geolocation.",
                    details: [
            ...
            improvement: [
                {
                    ...
                    description:
                        "Simplified server search and filtering flow for better maintainability and lower per-server overhead.",
                    details: [
            ...
            feature: [
                {
                    ...
                    description:
                        "Added password-protected admin controls for operational task handling and server moderation.",
                    details: [
            ...
            feature: [
                {
                    ...
                    title: "Rework",
                    description:
                        "Reworked the design of the website and the performance.",
                    details: [],
                },
            ],
        },
            ...
            feature: [
                {
                    ...
                    description:
                        "Added comprehensive game version filtering system to help users find servers running specific CS2 versions.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Added dedicated group page showcasing the CS2Browser.net ecosystem and related projects.",
                    details: [
            ...
            improvement: [
                {
                    ...
                    description:
                        "Fixed mobile navigation menu to support scrolling for better accessibility.",
                    details: [
            ...
            feature: [
                {
                    ...
                    description:
                        "Introduced comprehensive server banner generation system for embedding live server information on websites and forums.",
                    details: [
            ...
            improvement: [
                {
                    ...
                    description:
                        "Significantly improved server ranking algorithm to provide fair treatment for Zombie Escape (ZE) servers regardless of ping.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Enhanced banner preview section with improved layout and user experience.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Improved banner text display for better readability and cross-platform compatibility.",
                    details: [
            ...
            performance: [
                {
                    ...
                    description:
                        "Optimized banner generation system for improved performance and reliability.",
                    details: [
            ...
            feature: [
                {
                    ...
                    description:
                        "Introduced comprehensive metrics dashboard to track CS2Browser.net performance and server statistics.",
                    details: [
            ...
            improvement: [
                {
                    ...
                    description:
                        'Changed so that when the "Show Full Servers" is deactivated, all the servers with player count greater than the max players are hidden.',
                    details: [],
                },
            ],
        },
            ...
            improvement: [
                {
                    ...
                    description:
                        "Added warning notification when servers don't provide player names, helping users understand why players appear as anonymous.",
                    details: [
            ...
            performance: [
                {
                    ...
                    description:
                        "Optimized server detail API endpoint with improved histogram data handling and caching.",
                    details: [
            ...
            bugfix: [
                {
                    ...
                    description:
                        "Eliminated the passworded icon from server rows for a cleaner UI.",
                    details: [],
                },
            ],
        },
            ...
            feature: [
                {
                    ...
                    description:
                        "Added one-click server connection functionality directly from the server list.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Completely redesigned header navigation with organized dropdown menus and server addition functionality.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Implemented comprehensive server reporting system with advanced rate limiting.",
                    details: [
            ...
            improvement: [
                {
                    ...
                    description:
                        "Improved FAQ section with clickable links and better spacing.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Refined server list column layout for better visual alignment and spacing.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Increased map preview size for better visibility of server maps.",
                    details: [
            ...
            bugfix: [
                {
                    ...
                    description:
                        "Removed background glass effects and fixed various UI inconsistencies.",
                    details: [
            ...
            feature: [
                {
                    ...
                    description:
                        "Enhanced server search with comma-separated multi-tag search supporting AND logic.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Added exclusion search functionality using the ! prefix to filter out unwanted servers.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Added helpful search tooltip with comprehensive search tips and examples.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Created a complete API documentation page with interactive features and mobile-responsive design.",
                    details: [
                ...
                },
                {
                    ...
                    title: "Contact Page",
                    description:
                        "Added dedicated contact page with support methods and comprehensive FAQ section.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Added comprehensive server hiding system for personalized server browsing.",
                    details: [
            ...
            improvement: [
                {
                    ...
                    title: "Enhanced Header Navigation",
                    description:
                        "Updated header navigation to accommodate new pages with improved spacing and layout.",
                    details: [
            ...
            bugfix: [
                {
                    ...
                    description:
                        "Fixed server name overflow issues on server detail pages for small desktop resolutions.",
                    details: [
            ...
            feature: [
                {
                    ...
                    description:
                        "Added clickable ping and player column header with 3-mode sorting functionality.",
                    details: [
                ...
                },
                {
                    ...
                    title: "Donation Page",
                    description:
                        "Added a dedicated donation page to support CS2Browser.net.",
                    details: [
            ...
            improvement: [
                {
                    ...
                    description:
                        "Server name, tags, and IP address search now supports regex patterns.",
                    details: [
                ...
                },
                {
                    ...
                    title: "Filters",
                    description:
                        "Updated server filters for better browsing experience.",
                    details: [
            ...
            performance: [
                {
                    ...
                    description:
                        "Implemented comprehensive caching system across all API endpoints to improve performance.",
                    details: [
            ...
            bugfix: [
                {
                    ...
                    description:
                        "Resolved several issues with filtering and visibility in the server list.",
                    details: [
            ...
            improvement: [
                {
                    ...
                    description:
                        "Server list now prioritizes servers closer to the user’s region for better ping and connectivity.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        "Added user-selectable region filtering to refine server searches.",
                    details: [
                ...
                },
                {
                    ...
                    description:
                        'The "Copy IP" button now uses the standard Source engine connect format.',
                    details: [
            ...
            feature: [
                {
                    ...
                    description:
                        "Introduced a dedicated Discord support server for community and server management.",
                    details: [
...
export const hasChanges = (entry: ChangelogEntry) => {
    return Object.values(entry.changes).some(
